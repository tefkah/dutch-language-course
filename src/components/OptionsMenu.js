    ...
    <div className="options">
      <div className="menu">
        <Space direction="vertical">
          ...
          <Row className="menu-row"><Button block size="large" type="primary" onClick={() => { props.setGameOptions(number, [vowel1, vowel2].sort()[0] + ", " + [vowel1, vowel2].sort()[1]) }}>Let's  Gooo</Button></Row>
